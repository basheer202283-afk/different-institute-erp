-- ============================================================
-- Different Institute ERP - Complete Seed Data Script
-- Version: 1.0.0
-- Date: 2026-07-19
-- 
-- INSTRUCTIONS:
...
-- ============================================================
-- STEP 8: INSERT SAMPLE ATTENDANCE RECORDS
-- ============================================================
...
SELECT 'Organization' as entity, COUNT(*) as count FROM organizations WHERE id = 'org-001-0000-0000-000000000001'
UNION ALL
SELECT 'Branch', COUNT(*) FROM branches WHERE id = 'branch-001-0000-0000-000000000001'
UNION ALL
SELECT 'Tenant', COUNT(*) FROM tenants WHERE id = 'tenant-001-0000-0000-000000000001'
UNION ALL
SELECT 'Trainers', COUNT(*) FROM trainers WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001'
UNION ALL
SELECT 'Courses', COUNT(*) FROM courses WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001'
UNION ALL
SELECT 'Students', COUNT(*) FROM students WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001'
UNION ALL
SELECT 'Payments', COUNT(*) FROM payments WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001'
UNION ALL
SELECT 'Attendance', COUNT(*) FROM attendance_records WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001';
...
SELECT 
  (SELECT COUNT(*) FROM students WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001') as total_students,
  (SELECT COUNT(*) FROM trainers WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001') as total_trainers,
  (SELECT COUNT(*) FROM courses WHERE deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001') as total_courses,
  (SELECT COALESCE(SUM(amount), 0) FROM payments WHERE status = 'paid' AND deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001') as total_revenue,
  (SELECT COUNT(*) FROM attendance_records WHERE attendance_date = CURRENT_DATE AND deleted_at IS NULL AND organization_id = 'org-001-0000-0000-000000000001') as today_attendance;

-- ============================================================
-- SCRIPT COMPLETE!
-- ============================================================
-- After running this script:
-- 1. Refresh your dashboard at https://your-app.vercel.app/dashboard
-- 2. You should see:
--    - Students: 10
--    - Trainers: 5
--    - Courses: 6
--    - Revenue: 350,000 YER
--    - Today's Attendance: 7
-- ============================================================
